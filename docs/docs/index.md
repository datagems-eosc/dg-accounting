...
You can use the menu options on the left to navigate through the available documentation. You may be interested to jump directly to an [Architecture Overview](architecture.md), see the available [Onboarding Material](onboarding.md) or see available [Accounting Formats](accounting-formats.md). You can find here the service [code repository](https://github.com/datagems-eosc/dg-accounting).
